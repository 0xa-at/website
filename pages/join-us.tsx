...
export default function JoinUsPage() {
    ...
    return (
        <Box>
            ...
            <Button variant="contained" color="primary" size="large" href="https://docs.google.com/forms/d/e/1FAIpQLSeCmYIffrlJMj6rP2eMvMElnc1ePJm4UBA3wPJ_GWzkDOzkvQ/viewform?usp=sf_link" target="_blank" rel="noopener noreferrer">Join us</Button>
        </Box >
    )
}
